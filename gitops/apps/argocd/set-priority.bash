...
patch='{"spec":{"template":{"spec":{"priorityClassName":"homelab-critical","nodeSelector":{"isma.dev/stable":null,"tags.isma.dev/stable":null,"capability.isma.dev/stable":"true"}}}}}'
