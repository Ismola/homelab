...
# mantiene scripts/k3s/sync-node-tags.bash.
patch='{"spec":{"template":{"spec":{"priorityClassName":"homelab-critical","nodeSelector":{"isma.dev/stable":null,"tags.isma.dev/stable":"true"}}}}}'
